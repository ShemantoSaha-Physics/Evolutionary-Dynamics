...
class Society:
    ...
    def __init__(self, population_size, network_type='BA'):  # Default to BA network
...
def simulate_episode(episode_num, num_agent, initial_fraction, t):
